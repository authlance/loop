...
export interface SideBarProps extends React.ComponentProps<typeof Button> {
  setToggleSidebar?: (cb: () => void) => void
}
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex max-h-[100svh] flex-1 flex-col bg-background overflow-auto",
